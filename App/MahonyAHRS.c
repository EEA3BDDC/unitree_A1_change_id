...
//====================================================================================================
// Functions
void calculateAngles(AHRSIMU_t* AHRSIMU) {
...
void MahonyAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {  //9 Axis algorithm
	float recipNorm;
...
void MahonyAHRSupdateIMU(AHRSIMU_t* AHRSIMU, float gx, float gy, float gz, float ax, float ay, float az) { //6 Axis algorithm
	float recipNorm;
